...
class _PlaybackSettingsPageState extends ConsumerState<PlaybackSettingsPage> {
  ...
  /// push 会把左侧分类栏整个盖住，退出后还得重新点一次分类才能回来。
  String? _subPage;

  @override
  Widget build(BuildContext context) {
    if (_subPage == 'player') return SettingsSubPageScope(onBack: () => setState(() => _subPage = null), child: const PlayerSettingsPage());
    if (_subPage == 'keyframes') return SettingsSubPageScope(onBack: () => setState(() => _subPage = null), child: const KeyframesPage());
      ...
      body: ListView(
        ...
        children: [
           SettingsCardList(title: l10n.general, children: [
             SettingsCardItem(title: l10n.playerSettings, subtitle: l10n.playerSettingsDescription, leading: const Icon(Icons.tune_outlined), trailing: const Icon(Icons.chevron_right), onTap: () => setState(() => _subPage = 'player')),
           ...
           SettingsCardList(title: l10n.keyframes, children: [
             ...
             SettingsCardItem(title: l10n.keyframeManagement, subtitle: l10n.keyframeSettingsDescription, leading: const Icon(Icons.key_outlined), trailing: const Icon(Icons.chevron_right), onTap: () => setState(() => _subPage = 'keyframes')),
           ]),
